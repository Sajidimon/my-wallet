...
fun MainContentLayout(viewModel: WalletViewModel) {
    ...
    var selectedTab by remember { mutableStateOf(0) } // 0=Dashboard, 1=History, 2=Analytics, 3=Calendar, 4=Settings, 5=Categories
        ...
        ModalNavigationDrawer(
            ...
            drawerContent = {
                ModalDrawerSheet(
                    ...
                    val isCategoriesSelected = selectedTab == 5
                    NavigationDrawerItem(
                        label = {
                            Text(
                                text = "Categories",
                                fontWeight = if (isCategoriesSelected) FontWeight.Bold else FontWeight.Normal,
                                fontSize = 15.sp
                            )
                        },
                        ...
                        icon = {
                            Icon(
                                ...
                                tint = if (isCategoriesSelected) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.onSurfaceVariant
                            )
                        },
                        colors = NavigationDrawerItemDefaults.colors(
                            selectedContainerColor = MaterialTheme.colorScheme.primaryContainer.copy(alpha = 0.6f),
